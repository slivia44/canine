...
if (isset($_GET['confirm-btn'])) {
    ...
    if ($mama['phone_number'] != $number) {
        ...
        if ($exc) {
            ...
            header('location:sold.php?userid=' . $mama['id'] . '&houseid=' . $house . '&fromdate=' . $fromdate . '&todate=' . $todate);
        } else {
